...
def jogar():
    ...
    jogar_novamente(Ultima_pergunta())
...
def pede_chute(letras_chutadas):
    ...
    while (repetido):
        ...
        repetido = verifica_repetido(chute, letras_chutadas)
    return chute

def verifica_repetido(chute, letras_chutadas) :
        for index in range(0, len(letras_chutadas)):
            if (chute == letras_chutadas[index]):
